...
public class FoodDeliveryManageEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    private OrganizationDir orgDir;
    private JPanel userContainer;
    public FoodDeliveryManageEmployeeJPanel(JPanel rightSystemAdminPanel, OrganizationDir organizationDirectory) {
        initComponents();
        initComponents();
        this.userContainer = rightSystemAdminPanel;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MANAGE FOOD DELIVERY ENTERPRISE EMPLOYEE");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/delivery (2).png"))); // NOI18N
        jLabel5.setText("jLabel5");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 140, 140));
