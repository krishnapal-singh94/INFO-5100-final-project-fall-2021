 ...
 * @author KNN Team
 */
public class FoodDeliveryManageOrganizationJPanel extends javax.swing.JPanel {

    /**
     * Creates new form FoodDeliveryManageOrganizationJPanel
     */
    private OrganizationDir directory;
    private JPanel userContainer;
    private Enterprise enterprise;
    private String locationAddress;
    public FoodDeliveryManageOrganizationJPanel(JPanel rightSystemAdminPanel,OrganizationDir directory,Enterprise enterprise) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        organizationJComboBox.addItem(Organization.Type.Driver);
       
    }
    private void populateTable(){
        organizationJTable.getTableHeader().setDefaultRenderer(new TableColors());
        DefaultTableModel model = (DefaultTableModel) organizationJTable.getModel();
        System.out.println("manager org line num 61");
        model.setRowCount(0);
        ...
        for (Organization organization : directory.getListOfOrgs()){
        {
            System.out.println(organization.getLocationAddress() + " Food LOCATION");
              ...
              if(organization instanceof RestaurantOrg || organization instanceof PartyOrganizerOrg || 
                      ...
                      organization instanceof DriverOrganization){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if("".equals(orgNameTextField.getText())) {
            ...
            locationAddress = orgLocation.getText();
            Organization organization = directory.createOrg(type,orgNameTextField.getText(), locationAddress);
