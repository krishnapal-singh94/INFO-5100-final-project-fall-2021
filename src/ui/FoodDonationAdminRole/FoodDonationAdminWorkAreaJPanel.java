 ...
 * @author KNN Team
 */
public class FoodDonationAdminWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form FoodDonationAdminWorkAreaJPanel
     */
    ...
    public FoodDonationAdminWorkAreaJPanel(JPanel userProcessContainer,Enterprise enterprise,Network network,EcoSystem business) {
        ...
        System.out.println("fooddonationadminworkarea line number 31" + system);
        manageOrganization();
    }
    ...
    private void manageUser(){
        ...
        FoodDonationManageUserAccountJPanel muajp = new FoodDonationManageUserAccountJPanel(rightSystemAdminPanel, enterprise, system);
        rightSystemAdminPanel.add("FoodDonationManageUserAccountJPanel",muajp);
        CardLayout layout = (CardLayout) rightSystemAdminPanel.getLayout();
        layout.next(rightSystemAdminPanel);
    }
    private void manageRequest(){
        FoodDonationManageRequestJPanel manageRequestJPanel = new FoodDonationManageRequestJPanel(rightSystemAdminPanel, enterprise.getOrganizationDirectory(),network,system);
