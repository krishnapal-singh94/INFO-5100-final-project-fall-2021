...
import Business.Organization.FoodInspectOrg;
...
public class FoodSafetyManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public FoodSafetyManageOrganizationJPanel(JPanel userProcessContainer,OrganizationDir directory, Enterprise enterprise) {
        initComponents();
    ...
    private void populateTable(){
        ...
        {
            System.out.println(organization.getLocationAddress() + " Food safety org location");

              if(organization instanceof RestaurantOrg || organization instanceof PartyOrganizerOrg || 
                      organization instanceof IndividualFoodDonorOrg || organization instanceof FoodInspectOrg ){
